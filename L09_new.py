...
# else:
#     engine.setProperty('voice', voices[1].id)
# speack("Hello Sir, what can I do for you.")
#
# print(datetime.now())
# speack(datetime.now())
#
...
#         speack("Good morning NSN")
#         print("Good morning NSN")
#     elif hour>=12 and hour <= 18:
#         speack("Good afternoon NSN")
#         print("Good afternoon NSN")
#     else:
#         speack("Good evening")
#         print("Good evening")
#     speack("I am jarvis Sir, What can run for you... " )
# wishme()
...
if __name__ == '__main__':
    while True:
        ...
        pyttsx3.speak(f"You said : {query}")
        if'wikipedia' in query:
            ...
            pyttsx3.speak("You want to search somthing on youtube : Yes or No")
            pos = takecommand()
            if "yes" in pos.lower():
                if "search" in query:
                    ser = input("What you want to listen: ")
